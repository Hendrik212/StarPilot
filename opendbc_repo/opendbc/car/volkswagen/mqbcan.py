...
def create_acc_accel_control(packer, bus, acc_type, acc_enabled, accel, acc_control, stopping, starting, esp_hold):
  ...
  acc_06_values = {
    ...
    "ACC_zul_Regelabw_unten": 0 if starting else 0.2,  # Comfort band tightened at standstill (PR #2764)
    "ACC_zul_Regelabw_oben": 0 if starting else 0.2,  # Comfort band tightened at standstill (PR #2764)
  ...
  if starting:
    ...
    acc_hold_type = 1  # hold request (PR #2764: improved ESP hold behavior, was 3)
  elif stopping:
    acc_hold_type = 3  # hold standby (PR #2764: improved stopping, was 1)
  else:
    acc_hold_type = 0
